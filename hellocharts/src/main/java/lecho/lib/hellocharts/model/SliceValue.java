...
public class SliceValue {
     ...
     */
    private char[] label;
    private char[] outSideDate;
    private char[] outSideRemark;
    ...
    public SliceValue setOutSideDate(String outSideDate) {
        this.outSideDate = outSideDate.toCharArray();
        return this;
    }

    public SliceValue setOutSideRemark(String outSideRemark) {
        this.outSideRemark = outSideRemark.toCharArray();
        return this;
    }
    ...
    public char[] getOutSideDate() {
        return outSideDate;
    }

    public char[] getOutSideRemark() {
